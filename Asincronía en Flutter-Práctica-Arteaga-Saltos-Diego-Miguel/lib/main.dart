...
class _AnimatedScreenState extends State<AnimatedScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Llamadas asincrónicas'),
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 14, 134, 34),
          ...
          Column(
            children: [
              ElevatedButton(
                  ...
                  style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all(Color.fromARGB(255, 252, 255, 59))),
              ...
              AnimatedContainer(
                ...
                decoration: const BoxDecoration(color: Color.fromARGB(255, 252, 255, 59)),
              ),
              const SizedBox(
                height: 10,
              ),
          ...
          Column(
            children: [
              ElevatedButton(
                  ...
                  style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 212, 10, 10))),
                  child: const SizedBox(
                    width: 50.0,
                    height: 70.0,
                    child: Center(
              ...
              AnimatedContainer(
                ...
                decoration: const BoxDecoration(color: Color.fromARGB(255, 143, 6, 6)),
              ),
              const SizedBox(
                height: 10,
              ),
          ...
          Column(
            children: [
              ...
              AnimatedContainer(
                ...
                decoration: const BoxDecoration(color: Color.fromARGB(255, 54, 244, 111)),
              ),
              const SizedBox(
                height: 10,
              ),
